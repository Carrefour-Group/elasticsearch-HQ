...
class Elasticsearch(object):
    ...
    """
    # RSR: added version so we can tag the connection and decide what endpoints work or not on it.
    def __init__(self, hosts=None, transport_class=Transport, version='6.0.0', **kwargs):
        """
